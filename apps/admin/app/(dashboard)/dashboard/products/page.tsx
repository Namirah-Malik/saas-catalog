...
export default function ProductsPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res.ok) {
      setShowForm(false)
      setForm({ name: "", description: "", price: "", categoryId: "", isVisible: true })
      loadProducts()
    }
  }
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
              <div>
                ...
                <input
                  ...
                  style={{ width: "100%", padding: "9px 12px", border: "0.5px solid #d1d5db", borderRadius: 8, fontSize: 14, boxSizing: "border-box" }}
                />
              </div>
              <div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <textarea
                ...
                style={{ width: "100%", padding: "9px 12px", border: "0.5px solid #d1d5db", borderRadius: 8, fontSize: 14, boxSizing: "border-box", resize: "vertical" }}
              />
            </div>
